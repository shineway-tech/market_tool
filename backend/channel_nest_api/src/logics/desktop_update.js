...
class DesktopUpdateLogic {
  static getUpdate(target, arch, currentVersion) {
  ...
  static getDownloadFile(fileName) {
...
module.exports = DesktopUpdateLogic;
